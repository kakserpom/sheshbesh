...
fn lessons() -> Vec<Lesson> {
    ...
    out.push(Lesson {
        ...
        text: "2-я клетка от угла — Луна (подсвечена). Попав на неё, фишка улетает на внутреннюю \
               ...
               выброс 6, и фишка возвращается на доску. На Луне фишку нельзя съесть. Чужие Луны \
               срезают путь вперёд; своя Луна, у самого Дома, наоборот отправит фишку на второй круг.",
