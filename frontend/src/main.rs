        ...
        <div class="wrap">
            ...
            {move || about.get().then(|| view! {
                <div class="rules">
                    ...
                    <p>"Эта настольная игра была известна среди студентов МИФИ ещё в 70-е годы. Мой отец учился в МИФИ и играл в неё с одногруппниками."</p>
                    ...
                    <p>"Удалось найти лишь похожую настолку под названием «Шиш-Беш», но выглядит она иначе: поле в виде креста, без Луны и Тюрьмы."</p>
                </div>
            })}
